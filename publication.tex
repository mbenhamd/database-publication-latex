...
Nous avons mis en place un profil psychological par utilisateur actuel dans la base de données (à noter que cette fonctionnalité et aussi disponible dans le cas du streaming aussi). Ici nous avons pris le cas de Donald Trump en exemple puisqu'il est un utilisateur actif du réseau social.
Le problème de l'analyse de sentiment à partir des tweets de l'archive est qu'il n'ya pas tant de tweet que l'on n'imaginer par utilisateur.
